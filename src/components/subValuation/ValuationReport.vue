<template>
  <div class="ValuationReport2">
    <h3 class="title">{{fundFamilyName}}</h3>
    ...
    <div class="table-container2" style="width:100%;">
      <table class="table font12 table-condensed floatleft" style="width:70%;">
        ...
        <tr>
          ...
          <td>{{portfoliovaluation.fairvalue | formatNumber }}</td>
        </tr>
        <tr>
    ...
    methods: {
      valuationReport(){
        ...
        axioss.valuationReport(valuationid).then(res => {
          ...
          console.log(this.lastfinancialinfo);
          ...
          this.discountValue = (this.portfoliovaluation.valuation + this.portfoliovaluation.additional * 1) * this.portfoliovaluation.discount / 100;
